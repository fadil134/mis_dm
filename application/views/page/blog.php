            ...
            <div class="row gy-5 posts-list">
              ...
              <div class="col-lg-6">
                <article class="d-flex flex-column">
                  ...
                  <h2 class="title">
                    <a href="<?=base_url();?>blog-details.html">Dolorum optio tempore voluptas dignissimos cumque fuga qui quibusdam
                      quia</a>
                  </h2>
                  ...
                  <div class="meta-top">
                    <ul>
                      <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a
                          href="<?=base_url();?>blog-details.html">John Doe</a></li>
                      <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a
                          href="<?=base_url();?>blog-details.html"><time datetime="2022-01-01">Jan 1, 2022</time></a></li>
                      <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a
                          href="<?=base_url();?>blog-details.html">12 Comments</a></li>
                    </ul>
                  </div>
                  ...
                  <div class="read-more mt-auto align-self-end">
                    <a href="<?=base_url();?>blog-details.html">Read More <i class="bi bi-arrow-right"></i></a>
                  </div>
              ...
              <div class="col-lg-6">
                <article class="d-flex flex-column">
                  ...
                  <h2 class="title">
                    <a href="<?=base_url();?>blog-details.html">Nisi magni odit consequatur autem nulla dolorem</a>
                  </h2>
              ...
              <div class="col-lg-6">
                <article class="d-flex flex-column">
                  ...
                  <h2 class="title">
                    <a href="<?=base_url();?>blog-details.html">Possimus soluta ut id suscipit ea ut. In quo quia et soluta libero sit
                      sint.</a>
                  </h2>
              ...
              <div class="col-lg-6">
                <article class="d-flex flex-column">
                  ...
                  <h2 class="title">
                    <a href="<?=base_url();?>blog-details.html">Non rem rerum nam cum quo minus. Dolor distinctio deleniti explicabo
              ...
              <div class="col-lg-6">
                <article class="d-flex flex-column">
                  ...
                  <h2 class="title">
                    <a href="<?=base_url();?>blog-details.html">Accusamus quaerat aliquam qui debitis facilis consequatur</a>
                  </h2>
              ...
              <div class="col-lg-6">
                <article class="d-flex flex-column">
                  ...
                  <h2 class="title">
                    <a href="<?=base_url();?>blog-details.html">Distinctio provident quibusdam numquam aperiam aut</a>
                  </h2>
              ...
              <div class="sidebar-item recent-posts">
                ...
                <!-- End recent post item-->
                  ...
                  <div class="post-item">
                    ...
                    <div>
                      <h4><a href="<?=base_url();?>blog-post.html">Id quia et et ut maxime similique occaecati ut</a></h4>
                      <time datetime="2020-01-01">Jan 1, 2020</time>
                    </div>
                  </div>
                <!-- End recent post item-->
