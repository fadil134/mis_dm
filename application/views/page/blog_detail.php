            ...
            <div class="row g-5">
                ...
                <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <article class="blog-details">
                        ...
                        <div class="post-img">
                            <img src="<?= $artikel->url ?>" alt="" class="equal-size">
                        </div>
                    ...
                    <div class="post-author d-flex align-items-center">
                        <img src="<?= base_url() ?>assets/img/blog/blog-author.jpg" class="rounded-circle flex-shrink-0"
                            alt="">
                        <div>
                            <h4>
                                <?= $artikel->Nama_Penulis ?>
                            ...
                            <div class="social-links">
                                <a href="<?= base_url() ?>https://twitters.com/"><i class="bi bi-twitter"></i></a>
                                <a href="<?= base_url() ?>https://facebook.com/lidaf.11"><i
                                        class="bi bi-facebook"></i></a>
                                <a href="<?= base_url() ?>https://instagram.com/fadil.18/"><i
                        ...
                        <div id="comment-1" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="<?= base_url() ?>assets/img/blog/comments-1.jpg"
                                        alt=""></div>
                                <div>
                                    <h5><a href="<?= base_url() ?>">Georgia Reader</a> <a href="#" class="reply"><i
                        ...
                        <div id="comment-2" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="<?= base_url() ?>assets/img/blog/comments-2.jpg"
                                        alt=""></div>
                                <div>
                                    <h5><a href="<?= base_url() ?>">Aron Alvarado</a> <a href="#" class="reply"><i
                                                class="bi bi-reply-fill"></i>
                                            Reply</a></h5>
                                    <time datetime="2020-01-01">01 Jan,2022</time>
                                    <p>
                            ...
                            <div id="comment-reply-1" class="comment comment-reply">
                                <div class="d-flex">
                                    <div class="comment-img"><img src="<?= base_url() ?>assets/img/blog/comments-3.jpg"
                                            alt=""></div>
                                    <div>
                                        <h5><a href="<?= base_url() ?>">Lynda Small</a> <a href="#" class="reply"><i
                                                    class="bi bi-reply-fill"></i>
                                                Reply</a></h5>
                                        <time datetime="2020-01-01">01 Jan,2022</time>
                                        <p>
                                ...
                                <div id="comment-reply-2" class="comment comment-reply">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5><a href="<?= base_url() ?>">Sianna Ramsay</a> <a href="#"
                        ...
                        <div id="comment-3" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="<?= base_url() ?>assets/img/blog/comments-5.jpg"
                                        alt=""></div>
                                <div>
                                    <h5><a href="<?= base_url() ?>">Nolan Davidson</a> <a href="#" class="reply"><i
                                                class="bi bi-reply-fill"></i>
                                            Reply</a></h5>
                                    <time datetime="2020-01-01">01 Jan,2022</time>
                                    <p>
                        ...
                        <div id="comment-4" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="<?= base_url() ?>assets/img/blog/comments-6.jpg"
                                        alt=""></div>
                                <div>
                                    <h5><a href="<?= base_url() ?>">Kay Duggan</a> <a href="#" class="reply"><i
